...
public class DwhpartitionTest {
  ...
  private static Field LOADORDER;
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    newItem = Dwhpartition.class.getDeclaredField("newItem");
		...
		LOADORDER = Dwhpartition.class.getDeclaredField("LOADORDER");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Dwhpartition VALUES( 'testSTORAGEID'  ,'testTABLENAME'  ,'2000-01-01 00:00:00.0'  ,'2000-01-01 00:00:00.0'  ,'testSTATUS'  ,1 )");
  ...
  public void testDwhpartitionConstructorWithNullValues() throws Exception {
    ...
    String actual =  STORAGEID.get(objUnderTest)  + ", " + TABLENAME.get(objUnderTest)  + ", " + STARTTIME.get(objUnderTest)  + ", " + ENDTIME.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + LOADORDER.get(objUnderTest) ;
  ...
  public void testDwhpartitionConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  STORAGEID.get(objUnderTest)  + ", " + TABLENAME.get(objUnderTest)  + ", " + STARTTIME.get(objUnderTest)  + ", " + ENDTIME.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + LOADORDER.get(objUnderTest) ;
    String expected =  "testSTORAGEID"  + ", testTABLENAME"  + ", 2000-01-01 00:00:00.0"  + ", 2000-01-01 00:00:00.0"  + ", testSTATUS"  + ", 1" ;
    assertEquals(expected, actual);
  }
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Dwhpartition STORAGEID=\"'testSTORAGEID'\" TABLENAME=\"'testTABLENAME'\" STARTTIME=\"'2000-01-01 00:00:00.0'\" ENDTIME=\"'2000-01-01 00:00:00.0'\" STATUS=\"'testSTATUS'\" LOADORDER=\"1\" DiffStatus=\"\" />\n";
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Dwhpartition ( STORAGEID, TABLENAME, STARTTIME, ENDTIME, STATUS, LOADORDER ) values "
      + "( 'testSTORAGEID', 'testTABLENAME', '2000-01-01 00:00:00.0', '2000-01-01 00:00:00.0', 'testSTATUS', 1 );\n";
   ...
   */
  @Test
  public void testSetAndGetLoadorder() throws Exception {

    /* Data validating on */
    objUnderTest.setValidateData(true);

    /* Setting column values and asserting correct value is returned */
    objUnderTest.setLoadorder(555);
    assertEquals(555, LOADORDER.get(objUnderTest));
  }
  ...
  public void testRemoveNulls() throws Exception {
    ...
    String actual =  STORAGEID.get(objUnderTest)  + ", " + TABLENAME.get(objUnderTest)  + ", " + STARTTIME.get(objUnderTest)  + ", " + ENDTIME.get(objUnderTest)  + ", " + STATUS.get(objUnderTest)  + ", " + LOADORDER.get(objUnderTest) ;
    String expected =  ""  + ", "  + ", " + new Timestamp(0)  + ", " + new Timestamp(0)  + ", "  + ", 0" ;
    assertEquals(expected, actual);
  }
  ...
  */
  ...
  public void testGetStatusSQLType() throws Exception {
    ...
    /**
   * Testing columnsize retrieving for Loadorder.
   */
  @Test
  public void testGetLoadorderColumnSize() throws Exception {
    
     assertEquals(10, objUnderTest.getLoadorderColumnSize());   
  }

 /**
  * Testing decimal digits retrieving for Loadorder.
  */
  @Test
  public void testGetLoadorderDecimalDigits() throws Exception {
    
     assertEquals(0, objUnderTest.getLoadorderDecimalDigits());     
  }
  ...
  */
  @Test
  public void testGetLoadorderSQLType() throws Exception {
    
    assertEquals(4, objUnderTest.getLoadorderSQLType());    
  }
