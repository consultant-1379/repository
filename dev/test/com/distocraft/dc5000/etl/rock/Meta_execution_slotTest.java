...
public class Meta_execution_slotTest {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    newItem = Meta_execution_slot.class.getDeclaredField("newItem");
		...
		SERVICE_NODE = Meta_execution_slot.class.getDeclaredField("SERVICE_NODE");
  ...
  public void setUp() throws Exception {
    ...
    stmt.executeUpdate("INSERT INTO Meta_execution_slot VALUES(  'testPROFILE_ID'   ,  'testSLOT_NAME'   ,  'testSLOT_ID'   ,  'testACCEPTED_SET_TYPES'   ,  'testSERVICE_NODE'  )");
  ...
  public void testMeta_execution_slotConstructorWithNullValues() throws Exception {
    ...
    String actual =  PROFILE_ID.get(objUnderTest)  + ", " + SLOT_NAME.get(objUnderTest)  + ", " + SLOT_ID.get(objUnderTest)  + ", " + ACCEPTED_SET_TYPES.get(objUnderTest)  + ", " + SERVICE_NODE.get(objUnderTest) ;
  ...
  public void testMeta_execution_slotConstructorWithPrimaryKeyDefined() throws Exception {
    ...
    String actual =  PROFILE_ID.get(objUnderTest)  + ", " + SLOT_NAME.get(objUnderTest)  + ", " + SLOT_ID.get(objUnderTest)  + ", " + ACCEPTED_SET_TYPES.get(objUnderTest)  + ", " + SERVICE_NODE.get(objUnderTest) ;
    String expected =  "testPROFILE_ID"  + ", testSLOT_NAME"  + ", testSLOT_ID"  + ", testACCEPTED_SET_TYPES"  + ", testSERVICE_NODE" ;
    assertEquals(expected, actual);
  }
  ...
  public void testSaveToDB() throws Exception {
    ...
    /* Getting the PROFILE_ID column and see if it has changed */
    String queryResult = "";
    res = stmt.executeQuery("SELECT PROFILE_ID FROM Meta_execution_slot");
    while (res.next()) {
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Meta_execution_slot PROFILE_ID=\"'testPROFILE_ID'\" SLOT_NAME=\"'testSLOT_NAME'\" SLOT_ID=\"'testSLOT_ID'\" ACCEPTED_SET_TYPES=\"'testACCEPTED_SET_TYPES'\" SERVICE_NODE=\"'testSERVICE_NODE'\" DiffStatus=\"\" />\n";
  ...
  public void testToXML_endTag() throws Exception {
    ...
    assertEquals("</Meta_execution_slot>\n", objUnderTest.toXML_endTag());
  }
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Meta_execution_slot ( PROFILE_ID, SLOT_NAME, SLOT_ID, ACCEPTED_SET_TYPES, SERVICE_NODE ) values "
      + "( 'testPROFILE_ID', 'testSLOT_NAME', 'testSLOT_ID', 'testACCEPTED_SET_TYPES', 'testSERVICE_NODE' );\n";
  ...
  public void testSetAndGetService_node() throws Exception {
    ...
    /* Setting column values and asserting correct value is returned */
    objUnderTest.setService_node(Meta_execution_slotTest.testStringGenerator("anotherSERVICE_NODE", 64));
    assertEquals(Meta_execution_slotTest.testStringGenerator("anotherSERVICE_NODE", 64), SERVICE_NODE.get(objUnderTest));
  }
  ...
  public void testDbEquals() throws Exception {
    ...
    Meta_execution_slot compareObj = new Meta_execution_slot(rockFactory ,  "testSLOT_ID");

    /* Testing first with null primary key value */
    SLOT_ID.set(objUnderTest, null);
  	String actual = objUnderTest.dbEquals(compareObj) + ", ";
    
    /* Testing with different key value */
    SLOT_ID.set(objUnderTest,  "different");
  	actual += objUnderTest.dbEquals(compareObj) + ", ";
    
    /* Finally test with same value and test assertion */
    SLOT_ID.set(objUnderTest,  "testSLOT_ID");
  	actual += objUnderTest.dbEquals(compareObj);
  ...
  */
  ...
  /**
   * Testing original Meta_execution_slot object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Meta_execution_slot(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Meta_execution_slot changedOriginal = new Meta_execution_slot(rockFactory, false);
