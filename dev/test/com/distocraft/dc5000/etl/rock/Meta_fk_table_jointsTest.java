...
public class Meta_fk_table_jointsTest {
  ...
  public void testSaveToDB() throws Exception {
    ...
    String queryResult = "";
    res = stmt.executeQuery("SELECT VERSION_NUMBER FROM Meta_fk_table_joints");
    while (res.next()) {
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Meta_fk_table_joints VERSION_NUMBER=\"'testVERSION_NUMBER'\" CONNECTION_ID=\"1\" TABLE_ID=\"1\" COLUMN_ID_FK_COLUMN=\"1\" TARGET_TABLE_ID=\"1\" COLUMN_ID=\"1\" COLLECTION_SET_ID=\"1\" COLLECTION_ID=\"1\" TRANSFER_ACTION_ID=\"1\" DiffStatus=\"\" />\n";
  ...
  public void testToXML_endTag() throws Exception {
    ...
    assertEquals("</Meta_fk_table_joints>\n", objUnderTest.toXML_endTag());
  }
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Meta_fk_table_joints ( VERSION_NUMBER, CONNECTION_ID, TABLE_ID, COLUMN_ID_FK_COLUMN, TARGET_TABLE_ID, COLUMN_ID, COLLECTION_SET_ID, COLLECTION_ID, TRANSFER_ACTION_ID ) values "
      + "( 'testVERSION_NUMBER', 1, 1, 1, 1, 1, 1, 1, 1 );\n";
  ...
  public void testDbEquals() throws Exception {
    ...
    Meta_fk_table_joints compareObj = new Meta_fk_table_joints(rockFactory ,  "testVERSION_NUMBER",  1L ,  1L ,  1L ,  1L ,  1L ,  1L ,  1L ,  1L );

    /* Testing first with null primary key value */
    VERSION_NUMBER.set(objUnderTest, null);
  	CONNECTION_ID.set(objUnderTest, null);
  	TABLE_ID.set(objUnderTest, null);
  	COLUMN_ID_FK_COLUMN.set(objUnderTest, null);
    ...
    VERSION_NUMBER.set(objUnderTest,  "different");
  	...
  	COLUMN_ID_FK_COLUMN.set(objUnderTest,  7L );
    ...
    VERSION_NUMBER.set(objUnderTest,  "testVERSION_NUMBER");
  	...
  	COLUMN_ID_FK_COLUMN.set(objUnderTest,  1L );
  ...
  */
  ...
  /**
   * Testing original Meta_fk_table_joints object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Meta_fk_table_joints(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Meta_fk_table_joints changedOriginal = new Meta_fk_table_joints(rockFactory, false);
