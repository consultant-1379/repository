...
public class Meta_source_tablesTest {
  ...
  public void testSaveToDB() throws Exception {
    ...
    LAST_TRANSFER_DATE.set(objUnderTest, new Timestamp(946677600000L));
    HashSet testSet = new HashSet();
    testSet.add("LAST_TRANSFER_DATE");
    objUnderTest.setModifiedColumns(testSet);
    objUnderTest.saveToDB();
    ...
    /* Getting the LAST_TRANSFER_DATE column and see if it has changed */
    String queryResult = "";
    res = stmt.executeQuery("SELECT LAST_TRANSFER_DATE FROM Meta_source_tables");
    while (res.next()) {
    ...
    assertEquals("2, "+new Timestamp(946677600000L).toString()+"00000, " + false, actual);
  }
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Meta_source_tables LAST_TRANSFER_DATE=\"'2000-01-01 00:00:00.0'\" TRANSFER_ACTION_ID=\"1\" TABLE_ID=\"1\" USE_TR_DATE_IN_WHERE_FLAG=\"'testUSE_TR_DATE_IN_WHERE_FLAG'\" COLLECTION_SET_ID=\"1\" COLLECTION_ID=\"1\" CONNECTION_ID=\"1\" DISTINCT_FLAG=\"'testDISTINCT_FLAG'\" AS_SELECT_OPTIONS=\"'testAS_SELECT_OPTIONS'\" AS_SELECT_TABLESPACE=\"'testAS_SELECT_TABLESPACE'\" VERSION_NUMBER=\"'testVERSION_NUMBER'\" TIMESTAMP_COLUMN_ID=\"1\" DiffStatus=\"\" />\n";
  ...
  public void testToXML_endTag() throws Exception {
    ...
    assertEquals("</Meta_source_tables>\n", objUnderTest.toXML_endTag());
  }
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Meta_source_tables ( LAST_TRANSFER_DATE, TRANSFER_ACTION_ID, TABLE_ID, USE_TR_DATE_IN_WHERE_FLAG, COLLECTION_SET_ID, COLLECTION_ID, CONNECTION_ID, DISTINCT_FLAG, AS_SELECT_OPTIONS, AS_SELECT_TABLESPACE, VERSION_NUMBER, TIMESTAMP_COLUMN_ID ) values "
      + "( '2000-01-01 00:00:00.0', 1, 1, 'testUSE_TR_DATE_IN_WHERE_FLAG', 1, 1, 1, 'testDISTINCT_FLAG', 'testAS_SELECT_OPTIONS', 'testAS_SELECT_TABLESPACE', 'testVERSION_NUMBER', 1 );\n";
  ...
  public void testDbEquals() throws Exception {
    ...
    Meta_source_tables compareObj = new Meta_source_tables(rockFactory ,  1L ,  1L ,  1L ,  1L ,  1L ,  "testVERSION_NUMBER");
  ...
  */
  ...
  /**
   * Testing original Meta_source_tables object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Meta_source_tables(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Meta_source_tables changedOriginal = new Meta_source_tables(rockFactory, false);
