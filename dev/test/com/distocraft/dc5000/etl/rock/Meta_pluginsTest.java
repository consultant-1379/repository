...
public class Meta_pluginsTest {
  ...
  public void testSaveToDB() throws Exception {
    ...
    PLUGIN_ID.set(objUnderTest, 1L);
    HashSet testSet = new HashSet();
    testSet.add("PLUGIN_ID");
    objUnderTest.setModifiedColumns(testSet);
    objUnderTest.saveToDB();
    ...
    /* Getting the PLUGIN_ID column and see if it has changed */
    String queryResult = "";
    res = stmt.executeQuery("SELECT PLUGIN_ID FROM Meta_plugins");
    while (res.next()) {
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Meta_plugins PLUGIN_ID=\"1\" PLUGIN_NAME=\"'testPLUGIN_NAME'\" CONSTRUCTOR_PARAMETER=\"'testCONSTRUCTOR_PARAMETER'\" IS_SOURCE=\"'testIS_SOURCE'\" COLLECTION_SET_ID=\"1\" COLLECTION_ID=\"1\" COMMIT_AFTER_N_ROWS=\"1\" VERSION_NUMBER=\"'testVERSION_NUMBER'\" TRANSFER_ACTION_ID=\"1\" DiffStatus=\"\" />\n";
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Meta_plugins ( PLUGIN_ID, PLUGIN_NAME, CONSTRUCTOR_PARAMETER, IS_SOURCE, COLLECTION_SET_ID, COLLECTION_ID, COMMIT_AFTER_N_ROWS, VERSION_NUMBER, TRANSFER_ACTION_ID ) values "
      + "( 1, 'testPLUGIN_NAME', 'testCONSTRUCTOR_PARAMETER', 'testIS_SOURCE', 1, 1, 1, 'testVERSION_NUMBER', 1 );\n";
  ...
  public void testDbEquals() throws Exception {
    ...
    Meta_plugins compareObj = new Meta_plugins(rockFactory ,  1L ,  1L ,  1L ,  "testVERSION_NUMBER",  1L );

    /* Testing first with null primary key value */
    PLUGIN_ID.set(objUnderTest, null);
  ...
  */
  ...
  /**
   * Testing original Meta_plugins object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Meta_plugins(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Meta_plugins changedOriginal = new Meta_plugins(rockFactory, false);
