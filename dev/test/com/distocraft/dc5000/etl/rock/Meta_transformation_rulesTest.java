...
public class Meta_transformation_rulesTest {
  ...
  public void testSaveToDB() throws Exception {
    ...
    TRANSFORMATION_ID.set(objUnderTest, 1L);
    HashSet testSet = new HashSet();
    testSet.add("TRANSFORMATION_ID");
    objUnderTest.setModifiedColumns(testSet);
    objUnderTest.saveToDB();
    ...
    /* Getting the TRANSFORMATION_ID column and see if it has changed */
    String queryResult = "";
    res = stmt.executeQuery("SELECT TRANSFORMATION_ID FROM Meta_transformation_rules");
    while (res.next()) {
  ...
  public void testToXML_tag() throws Exception {
    ...
    String expected = "<Meta_transformation_rules TRANSFORMATION_ID=\"1\" TRANSFORMATION_NAME=\"'testTRANSFORMATION_NAME'\" CODE=\"'testCODE'\" DESCRIPTION=\"'testDESCRIPTION'\" VERSION_NUMBER=\"'testVERSION_NUMBER'\" DiffStatus=\"\" />\n";
  ...
  public void testToXML_endTag() throws Exception {
    ...
    assertEquals("</Meta_transformation_rules>\n", objUnderTest.toXML_endTag());
  }
  ...
  public void testToSQLInsert() throws Exception {
    ...
    String expected = "insert into Meta_transformation_rules ( TRANSFORMATION_ID, TRANSFORMATION_NAME, CODE, DESCRIPTION, VERSION_NUMBER ) values "
      + "( 1, 'testTRANSFORMATION_NAME', 'testCODE', 'testDESCRIPTION', 'testVERSION_NUMBER' );\n";
  ...
  public void testDbEquals() throws Exception {
    ...
    Meta_transformation_rules compareObj = new Meta_transformation_rules(rockFactory ,  1L ,  "testVERSION_NUMBER");

    /* Testing first with null primary key value */
    TRANSFORMATION_ID.set(objUnderTest, null);
  ...
  */
  ...
  /**
   * Testing original Meta_transformation_rules object setting and retrieving.
   */
  @Test
  public void testSetAndGetOriginal() throws Exception {

    objUnderTest = new Meta_transformation_rules(rockFactory, false);
  ...
  public void testIsUpdated() throws Exception {
    ...
    Meta_transformation_rules changedOriginal = new Meta_transformation_rules(rockFactory, false);
