...
/**
 * This class is used for creating the interface set for a ENIQ EVENTS techpack.
 * 
 * @author epaujor
 * 
 */
public class EventsCreateInterfaceSet extends CreateInterfaceSet {

  public EventsCreateInterfaceSet(final String objType, final String templateDir, final String tpVersion,
  ...
  protected String getVelocityTemplateName() {
    return "events_defaultAdapter.vm";
  }
}
