...
public class Meta_fk_tables implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSION_NUMBER"    ,"COLLECTION_SET_ID"    ,"COLLECTION_ID"    ,"TRANSFER_ACTION_ID"    ,"CONNECTION_ID"    ,"TABLE_ID"    ,"TARGET_TABLE_ID"   };
  ...
  private Meta_fk_tables original; 

  public Meta_fk_tables(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Meta_fk_tables(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Meta_fk_tables(final RockFactory rockFact   ,final String VERSION_NUMBER ,final Long COLLECTION_SET_ID ,final Long COLLECTION_ID ,final Long TRANSFER_ACTION_ID ,final Long CONNECTION_ID ,final Long TABLE_ID ,final Long TARGET_TABLE_ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Meta_fk_tables> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Meta_fk_tables o = it.next();
   ...
   * @exception SQLException
   */
  public Meta_fk_tables(final RockFactory rockFact, final Meta_fk_tables whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Meta_fk_tables> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Meta_fk_tables o = it.next();
                this.MAX_ERRORS = o.getMax_errors();
                this.VERSION_NUMBER = o.getVersion_number();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Meta_fk_tables whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Meta_fk_tables whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Meta_fk_tables ");
        ...
        sbuff.append("WHERE_CLAUSE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.WHERE_CLAUSE),12, true)+"\" ");
        sbuff.append("FILTER_ERRORS_FLAG=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.FILTER_ERRORS_FLAG),12, true)+"\" ");
        sbuff.append("REPLACE_ERRORS_FLAG=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.REPLACE_ERRORS_FLAG),12, true)+"\" ");
        sbuff.append("REPLACE_ERRORS_WITH=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.REPLACE_ERRORS_WITH),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    final StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Meta_fk_tables ( ");
	    		sbuff.append("MAX_ERRORS");
		    		sbuff.append(", VERSION_NUMBER");
	    		sbuff.append(", WHERE_CLAUSE");
	    		sbuff.append(", FILTER_ERRORS_FLAG");
	    		sbuff.append(", REPLACE_ERRORS_FLAG");
	    		sbuff.append(", REPLACE_ERRORS_WITH");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.WHERE_CLAUSE,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.FILTER_ERRORS_FLAG,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.REPLACE_ERRORS_FLAG,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.REPLACE_ERRORS_WITH,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setFilter_errors_flag(final String FILTER_ERRORS_FLAG) {
    if (validateData){
   ...
   public void setReplace_errors_flag(final String REPLACE_ERRORS_FLAG) {
    if (validateData){
   ...
   public void setReplace_errors_with(final String REPLACE_ERRORS_WITH) {
    if (validateData){
  ...
  public boolean dbEquals(final Meta_fk_tables o) {
  ...
  public boolean equals(final Meta_fk_tables o) {
  ...
  */
  ...
  public Meta_fk_tables getOriginal() {
    return original;
  }
   
  public void setOriginal(final Meta_fk_tables original) {
    this.original = (Meta_fk_tables) original.clone();
  }
