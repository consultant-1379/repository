...
public class Meta_statuses implements Cloneable,RockDBObject  {
  ...
  private Meta_statuses original; 

  public Meta_statuses(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Meta_statuses(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Meta_statuses(final RockFactory rockFact   ,final Long ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Meta_statuses> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Meta_statuses o = it.next();
   ...
   * @exception SQLException
   */
  public Meta_statuses(final RockFactory rockFact, final Meta_statuses whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Meta_statuses> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Meta_statuses o = it.next();
                this.ID = o.getId();
                this.STATUS_DESCRIPTION = o.getStatus_description();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Meta_statuses whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Meta_statuses whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Meta_statuses ");
        sbuff.append("ID=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.ID),2, true)+"\" ");
        sbuff.append("STATUS_DESCRIPTION=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.STATUS_DESCRIPTION),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    final StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Meta_statuses ( ");
	    		sbuff.append("ID");
		    		sbuff.append(", STATUS_DESCRIPTION");
	        ...
	        sbuff.append(" ) values ( ");
    	        sbuff.append(""+DataValidator.wrap(""+this.ID,2)+"");
        	        sbuff.append(", "+DataValidator.wrap(""+this.STATUS_DESCRIPTION,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setStatus_description(final String STATUS_DESCRIPTION) {
    if (validateData){
  ...
  public boolean dbEquals(final Meta_statuses o) {
  ...
  public boolean equals(final Meta_statuses o) {
  ...
  */
  ...
  public Meta_statuses getOriginal() {
    return original;
  }
   
  public void setOriginal(final Meta_statuses original) {
    this.original = (Meta_statuses) original.clone();
  }
