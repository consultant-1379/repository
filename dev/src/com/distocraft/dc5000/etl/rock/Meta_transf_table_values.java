...
public class Meta_transf_table_values implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "OLD_VALUE"    ,"VERSION_NUMBER"    ,"TRANSF_TABLE_ID"   };
  ...
  private Meta_transf_table_values original; 

  public Meta_transf_table_values(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Meta_transf_table_values(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Meta_transf_table_values(final RockFactory rockFact   ,final String OLD_VALUE ,final String VERSION_NUMBER ,final Long TRANSF_TABLE_ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Meta_transf_table_values> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Meta_transf_table_values o = it.next();
   ...
   * @exception SQLException
   */
  public Meta_transf_table_values(final RockFactory rockFact, final Meta_transf_table_values whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Meta_transf_table_values> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Meta_transf_table_values o = it.next();
                this.OLD_VALUE = o.getOld_value();
                this.NEW_VALUE = o.getNew_value();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Meta_transf_table_values whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Meta_transf_table_values whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Meta_transf_table_values ");
        sbuff.append("OLD_VALUE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.OLD_VALUE),12, true)+"\" ");
        sbuff.append("NEW_VALUE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.NEW_VALUE),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    final StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Meta_transf_table_values ( ");
	    		sbuff.append("OLD_VALUE");
		    		sbuff.append(", NEW_VALUE");
	    		sbuff.append(", VERSION_NUMBER");
	    		sbuff.append(", TRANSF_TABLE_ID");
	        sbuff.append(" ) values ( ");
    	        sbuff.append(""+DataValidator.wrap(""+this.OLD_VALUE,12)+"");
        	        sbuff.append(", "+DataValidator.wrap(""+this.NEW_VALUE,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setOld_value(final String OLD_VALUE) {
    if (validateData){
   ...
   public void setNew_value(final String NEW_VALUE) {
    if (validateData){
  ...
  public boolean dbEquals(final Meta_transf_table_values o) {
  ...
  public boolean equals(final Meta_transf_table_values o) {
  ...
  */
  ...
  public Meta_transf_table_values getOriginal() {
    return original;
  }
   
  public void setOriginal(final Meta_transf_table_values original) {
    this.original = (Meta_transf_table_values) original.clone();
  }
