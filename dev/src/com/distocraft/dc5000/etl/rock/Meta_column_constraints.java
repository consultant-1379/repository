...
public class Meta_column_constraints implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "ID"    ,"VERSION_NUMBER"    ,"CONNECTION_ID"    ,"TABLE_ID"    ,"COLUMN_ID"   };
  ...
  private Meta_column_constraints original; 

  public Meta_column_constraints(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Meta_column_constraints(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Meta_column_constraints(final RockFactory rockFact   ,final Long ID ,final String VERSION_NUMBER ,final Long CONNECTION_ID ,final Long TABLE_ID ,final Long COLUMN_ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Meta_column_constraints> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Meta_column_constraints o = it.next();
   ...
   * @exception SQLException
   */
  public Meta_column_constraints(final RockFactory rockFact, final Meta_column_constraints whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Meta_column_constraints> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Meta_column_constraints o = it.next();
                this.ID = o.getId();
                this.LOW_VALUE = o.getLow_value();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Meta_column_constraints whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Meta_column_constraints whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Meta_column_constraints ");
        sbuff.append("ID=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.ID),2, true)+"\" ");
        sbuff.append("LOW_VALUE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.LOW_VALUE),12, true)+"\" ");
        sbuff.append("HIGH_VALUE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.HIGH_VALUE),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    final StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Meta_column_constraints ( ");
	    		sbuff.append("ID");
		    		sbuff.append(", LOW_VALUE");
	    		sbuff.append(", HIGH_VALUE");
	        ...
	        sbuff.append(" ) values ( ");
    	        sbuff.append(""+DataValidator.wrap(""+this.ID,2)+"");
        	        sbuff.append(", "+DataValidator.wrap(""+this.LOW_VALUE,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.HIGH_VALUE,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setLow_value(final String LOW_VALUE) {
    if (validateData){
   ...
   public void setHigh_value(final String HIGH_VALUE) {
    if (validateData){
  ...
  public boolean dbEquals(final Meta_column_constraints o) {
  ...
  public boolean equals(final Meta_column_constraints o) {
  ...
  */
  ...
  public Meta_column_constraints getOriginal() {
    return original;
  }
   
  public void setOriginal(final Meta_column_constraints original) {
    this.original = (Meta_column_constraints) original.clone();
  }
