...
public class Meta_errors implements Cloneable,RockDBObject  {
  ...
  private Meta_errors original; 

  public Meta_errors(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Meta_errors(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Meta_errors(final RockFactory rockFact   ,final Long ID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Meta_errors> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Meta_errors o = it.next();
   ...
   * @exception SQLException
   */
  public Meta_errors(final RockFactory rockFact, final Meta_errors whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Meta_errors> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Meta_errors o = it.next();
                this.ID = o.getId();
                this.TEXT = o.getText();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Meta_errors whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Meta_errors whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Meta_errors ");
        ...
        sbuff.append("METHOD_NAME=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.METHOD_NAME),12, true)+"\" ");
        sbuff.append("ERR_TYPE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.ERR_TYPE),12, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    final StringBuffer sbuff = new StringBuffer();
    sbuff.append("insert into Meta_errors ( ");
	    		sbuff.append("ID");
		    		sbuff.append(", TEXT");
	    		sbuff.append(", METHOD_NAME");
	    		sbuff.append(", ERR_TYPE");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.METHOD_NAME,12)+"");
    	        sbuff.append(", "+DataValidator.wrap(""+this.ERR_TYPE,12)+"");
  ...
  public void removeNulls() {
   ...
   public void setMethod_name(final String METHOD_NAME) {
    if (validateData){
   ...
   public void setErr_type(final String ERR_TYPE) {
    if (validateData){
  ...
  public boolean dbEquals(final Meta_errors o) {
  ...
  public boolean equals(final Meta_errors o) {
  ...
  */
  ...
  public Meta_errors getOriginal() {
    return original;
  }
   
  public void setOriginal(final Meta_errors original) {
    this.original = (Meta_errors) original.clone();
  }
