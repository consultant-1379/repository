...
public class Partitionplan implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "PARTITIONPLAN"   };
  ...
  public Partitionplan(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Partitionplan(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Partitionplan(final RockFactory rockFact   ,final String PARTITIONPLAN ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Partitionplan> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Partitionplan o = it.next();
              ...
              this.PARTITIONTYPE = o.getPartitiontype();
   ...
   * @exception SQLException
   */
  public Partitionplan(final RockFactory rockFact, final Partitionplan whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Partitionplan> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Partitionplan o = it.next();
                this.PARTITIONPLAN = o.getPartitionplan();
                this.DEFAULTSTORAGETIME = o.getDefaultstoragetime();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Partitionplan whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Partitionplan whereObject) throws SQLException, RockException {
    this.newItem = true;
   ...
   */
    ...
    sbuff.append("<Partitionplan ");
        ...
        sbuff.append("PARTITIONTYPE=\""+DataValidator.wrap(DataValidator.escapeXML(""+this.PARTITIONTYPE),-6, true)+"\" ");
  ...
  public String toSQLInsert(){
    ...
    sbuff.append("insert into Partitionplan ( ");
	        ...
	        sbuff.append(" ) values ( ");
    	        ...
    	        sbuff.append(", "+DataValidator.wrap(""+this.PARTITIONTYPE,-6)+"");
    	    sbuff.append(" );\n");   
    return sbuff.toString();
  }
  ...
  public void removeNulls() {
     ...
     if (PARTITIONTYPE == null) {
      PARTITIONTYPE = new Short ( (short)0);
    }
   }
   ...
   public void setDefaultstoragetime(final Long DEFAULTSTORAGETIME) {
    if (validateData){
      DataValidator.validateData((Object)DEFAULTSTORAGETIME,"DEFAULTSTORAGETIME",2,20,0);
    }
    modifiedColumns.add("DEFAULTSTORAGETIME");
    this.DEFAULTSTORAGETIME = DEFAULTSTORAGETIME;
  }
   public void setDefaultpartitionsize(final Long DEFAULTPARTITIONSIZE) {
    if (validateData){
      DataValidator.validateData((Object)DEFAULTPARTITIONSIZE,"DEFAULTPARTITIONSIZE",2,20,0);
    }
    modifiedColumns.add("DEFAULTPARTITIONSIZE");
    this.DEFAULTPARTITIONSIZE = DEFAULTPARTITIONSIZE;
  }
   public void setMaxstoragetime(final Long MAXSTORAGETIME) {
    if (validateData){
      DataValidator.validateData((Object)MAXSTORAGETIME,"MAXSTORAGETIME",2,20,0);
    }
    modifiedColumns.add("MAXSTORAGETIME");
    this.MAXSTORAGETIME = MAXSTORAGETIME;
  }
   public void setPartitiontype(final Short PARTITIONTYPE) {
    if (validateData){
      DataValidator.validateData((Object)PARTITIONTYPE,"PARTITIONTYPE",-6,3,0);
    }
    modifiedColumns.add("PARTITIONTYPE");
  ...
  public boolean dbEquals(final Partitionplan o) {
  ...
  public boolean equals(final Partitionplan o) {
         ...
         if ((((this.PARTITIONPLAN == null) || (o.PARTITIONPLAN == null)) && (this.PARTITIONPLAN != o.PARTITIONPLAN))
            ...
            || (((this.PARTITIONTYPE == null) || (o.PARTITIONTYPE == null)) && (this.PARTITIONTYPE != o.PARTITIONTYPE))
          ){
    return false;
    } else
         if ((((this.PARTITIONPLAN != null) && (o.PARTITIONPLAN != null)) && (this.PARTITIONPLAN.equals(o.PARTITIONPLAN) == false))
            ...
            || (((this.PARTITIONTYPE != null) && (o.PARTITIONTYPE != null)) && (this.PARTITIONTYPE.equals(o.PARTITIONTYPE) == false))
          ){
    return false;
    } else {
      return true;
  ...
  * return 3
  */
  public static int getPartitiontypeColumnSize() {
  ...
  * return 0
  */
  public static int getPartitiontypeDecimalDigits() {
  ...
  * return -6
  */
  public static int getPartitiontypeSQLType() {
  ...
  public void setOriginal(final Partitionplan original) {
