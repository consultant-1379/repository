...
public class Busyhoursource implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSIONID"    ,"BHLEVEL"    ,"BHTYPE"    ,"TYPENAME"    ,"TARGETVERSIONID"    ,"BHOBJECT"   };
  ...
  public Busyhoursource(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Busyhoursource(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Busyhoursource(final RockFactory rockFact   ,final String VERSIONID ,final String BHLEVEL ,final String BHTYPE ,final String TYPENAME ,final String TARGETVERSIONID ,final String BHOBJECT ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Busyhoursource> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Busyhoursource o = it.next();
   ...
   * @exception SQLException
   */
  public Busyhoursource(final RockFactory rockFact, final Busyhoursource whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Busyhoursource> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Busyhoursource o = it.next();
                this.VERSIONID = o.getVersionid();
                this.BHLEVEL = o.getBhlevel();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Busyhoursource whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Busyhoursource whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(final Busyhoursource o) {
  ...
  public boolean equals(final Busyhoursource o) {
  ...
  */
  ...
  public void setOriginal(final Busyhoursource original) {
