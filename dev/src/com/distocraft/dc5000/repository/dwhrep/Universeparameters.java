...
public class Universeparameters implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSIONID"    ,"CLASSNAME"    ,"OBJECTNAME"    ,"UNIVERSEEXTENSION"    ,"ORDERNRO"   };
  ...
  public Universeparameters(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeparameters(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Universeparameters(final RockFactory rockFact   ,final String VERSIONID ,final String CLASSNAME ,final String OBJECTNAME ,final String UNIVERSEEXTENSION ,final Integer ORDERNRO ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Universeparameters> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Universeparameters o = it.next();
   ...
   * @exception SQLException
   */
  public Universeparameters(final RockFactory rockFact, final Universeparameters whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Universeparameters> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Universeparameters o = it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Universeparameters whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Universeparameters whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setOrdernro(final Integer ORDERNRO) {
    if (validateData){
  ...
  public boolean dbEquals(final Universeparameters o) {
  ...
  public boolean equals(final Universeparameters o) {
  ...
  */
  ...
  public void setOriginal(final Universeparameters original) {
