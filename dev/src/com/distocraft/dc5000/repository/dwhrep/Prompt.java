...
public class Prompt implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSIONID"    ,"PROMPTIMPLEMENTORID"    ,"PROMPTNAME"   };
  ...
  public Prompt(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Prompt(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Prompt(final RockFactory rockFact   ,final String VERSIONID ,final Integer PROMPTIMPLEMENTORID ,final String PROMPTNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Prompt> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Prompt o = it.next();
   ...
   * @exception SQLException
   */
  public Prompt(final RockFactory rockFact, final Prompt whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Prompt> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Prompt o = it.next();
                this.VERSIONID = o.getVersionid();
                this.PROMPTIMPLEMENTORID = o.getPromptimplementorid();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Prompt whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Prompt whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setPromptname(final String PROMPTNAME) {
    if (validateData){
   ...
   public void setUnrefreshable(final String UNREFRESHABLE) {
    if (validateData){
  ...
  public boolean dbEquals(final Prompt o) {
  ...
  public boolean equals(final Prompt o) {
  ...
  */
  ...
  public void setOriginal(final Prompt original) {
