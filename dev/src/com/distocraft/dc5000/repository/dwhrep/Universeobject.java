...
public class Universeobject implements Cloneable,RockDBObject  {
  ...
  public Universeobject(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Universeobject(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Universeobject(final RockFactory rockFact   ,final String VERSIONID ,final String CLASSNAME ,final String UNIVERSEEXTENSION ,final String OBJECTNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Universeobject> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Universeobject o = it.next();
   ...
   * @exception SQLException
   */
  public Universeobject(final RockFactory rockFact, final Universeobject whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Universeobject> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Universeobject o = it.next();
                this.VERSIONID = o.getVersionid();
                this.CLASSNAME = o.getClassname();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Universeobject whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Universeobject whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(final Universeobject o) {
  ...
  public boolean equals(final Universeobject o) {
  ...
  */
  ...
  public void setOriginal(final Universeobject original) {
