...
public class Busyhourplaceholders implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSIONID"    ,"BHLEVEL"   };
  ...
  public Busyhourplaceholders(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Busyhourplaceholders(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Busyhourplaceholders(final RockFactory rockFact   ,final String VERSIONID ,final String BHLEVEL ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Busyhourplaceholders> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Busyhourplaceholders o = it.next();
   ...
   * @exception SQLException
   */
  public Busyhourplaceholders(final RockFactory rockFact, final Busyhourplaceholders whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Busyhourplaceholders> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Busyhourplaceholders o = it.next();
                this.VERSIONID = o.getVersionid();
                this.BHLEVEL = o.getBhlevel();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Busyhourplaceholders whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Busyhourplaceholders whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public void removeNulls() {
   ...
   public void setProductplaceholders(final Integer PRODUCTPLACEHOLDERS) {
    if (validateData){
   ...
   public void setCustomplaceholders(final Integer CUSTOMPLACEHOLDERS) {
    if (validateData){
  ...
  public boolean dbEquals(final Busyhourplaceholders o) {
  ...
  public boolean equals(final Busyhourplaceholders o) {
  ...
  */
  ...
  public void setOriginal(final Busyhourplaceholders original) {
