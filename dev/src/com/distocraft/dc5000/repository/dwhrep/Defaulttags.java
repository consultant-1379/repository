...
public class Defaulttags implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "TAGID"    ,"DATAFORMATID"   };
  ...
  public Defaulttags(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Defaulttags(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Defaulttags(final RockFactory rockFact   ,final String TAGID ,final String DATAFORMATID ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Defaulttags> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Defaulttags o = it.next();
   ...
   * @exception SQLException
   */
  public Defaulttags(final RockFactory rockFact, final Defaulttags whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Defaulttags> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Defaulttags o = it.next();
                this.TAGID = o.getTagid();
                this.DATAFORMATID = o.getDataformatid();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Defaulttags whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Defaulttags whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(final Defaulttags o) {
  ...
  public boolean equals(final Defaulttags o) {
  ...
  */
  ...
  public void setOriginal(final Defaulttags original) {
