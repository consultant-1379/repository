...
public class Promptoption implements Cloneable,RockDBObject  {
  ...
  private final String[] primaryKeyNames = {    "VERSIONID"    ,"PROMPTIMPLEMENTORID"    ,"OPTIONNAME"   };
  ...
  public Promptoption(final RockFactory rockFact) {
  	this(rockFact, false);
  	original = null; 
  }
   ...
   */
  public Promptoption(final RockFactory rockFact, final boolean validate) {
   ...
   */
  public Promptoption(final RockFactory rockFact   ,final String VERSIONID ,final Integer PROMPTIMPLEMENTORID ,final String OPTIONNAME ) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      ...
      final Iterator<Promptoption> it = rockFact.getData(this, results);
      if (it.hasNext()) {
        final Promptoption o = it.next();
   ...
   * @exception SQLException
   */
  public Promptoption(final RockFactory rockFact, final Promptoption whereObject) throws SQLException,
      RockException {
    try {
      this.rockFact = rockFact;
      final RockResultSet results = rockFact.setSelectSQL(false, whereObject);
      final Iterator<Promptoption> it = rockFact.getData(whereObject, results);
      if (it.hasNext()) {
        final Promptoption o = it.next();
                this.VERSIONID = o.getVersionid();
                this.PROMPTIMPLEMENTORID = o.getPromptimplementorid();
   ...
   * @exception SQLException
   */
  public int updateDB(final boolean useTimestamp, final Promptoption whereObject) throws SQLException, RockException {
    this.newItem = false;
   ...
   * @exception SQLException
   */
  public int deleteDB(final Promptoption whereObject) throws SQLException, RockException {
    this.newItem = true;
  ...
  public boolean dbEquals(final Promptoption o) {
  ...
  public boolean equals(final Promptoption o) {
  ...
  */
  ...
  public void setOriginal(final Promptoption original) {
